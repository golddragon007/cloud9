...
case $2 in
clean) $CLOUD/system.sh;$CLOUD/basic.sh;$CLOUD/native.sh;$CLOUD/configure.sh $1;$CLOUD/install.sh $1 clean;;
clone) $CLOUD/system.sh;$CLOUD/basic.sh;$CLOUD/native.sh;$CLOUD/configure.sh $1;$CLOUD/clone.sh $1;$CLOUD/install.sh $1 clone;;
