...
echo "PortForwardings"="L22=github.com:22,L222=localhost:22,L3306=localhost:3306,L8080=localhost:8080,L8081=localhost:8081,L8082=localhost:8082,L8983=localhost:8983,R9000=localhost:9000" >> "%temp_regfile_name%"
