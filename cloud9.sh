...
m) $LIB/system.sh;$LIB/ip.sh;$LIB/minimal.sh;$LIB/runners.sh;;
p) $LIB/system.sh;$LIB/ip.sh;$LIB/minimal.sh;$LIB/lamp.sh;$LIB/runners.sh;;
x) $LIB/system.sh;$LIB/ip.sh;$LIB/minimal.sh;$LIB/lamp.sh;$LIB/xdebug.sh;$LIB/runners.sh;;
t) $LIB/system.sh;$LIB/ip.sh;$LIB/minimal.sh;$LIB/lamp.sh;$LIB/xdebug.sh;$LIB/selenium.sh;$LIB/runners.sh;;
