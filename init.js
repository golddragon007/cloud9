...
menus.addItemByPath(menuCaption + "/Configure/Test", new MenuItem({
  onclick: test
}), 101, plugin);

menus.addItemByPath(menuCaption + "/Configure/Config git", new MenuItem({
  onclick: configGit
}), 102, plugin);
...
// -- CloudKitMenu Lamp --
menus.addItemByPath(menuCaption + "/Lamp", new MenuItem({}), 101, plugin);

menus.addItemByPath(menuCaption + "/Lamp/Services", new MenuItem({}), 100, plugin);

menus.addItemByPath(menuCaption + "/Lamp/Services/Status", new MenuItem({
  onclick: servicesStatus
}), 101, plugin);

menus.addItemByPath(menuCaption + "/Lamp/Services/Restart", new MenuItem({
  onclick: generateDockerComposeFile
}), 102, plugin);
...
function configGit() {
  ...
  function mySubmitOnClick() {
    ...
    myDialog.hide();
    var pi=JSON.stringify({"git" : {"username" : values["user"].trim(), "mail" : values["mail"].trim()}});
    var option = [
      'pillar=' + '\'' + pi + '\''
    ]
...
HelpPanel.on("draw", function(e) {
  e.html.style.padding = "10px";
  e.html.style.color = "#eee";
  e.html.innerHTML = "<h1>Help</h1>" +
    "<h2>Docker</h2>" +
    "<ul>" +
    "<li>Configure my environment for <a style='color:#729fcf' href=\"https://webgate.ec.europa.eu/fpfis/wikis/display/MULTISITE/AWS+Cloud9+-+Docker\">Docker</a></li>" +
    "<li>Work with <a style='color:#729fcf' href=\"https://webgate.ec.europa.eu/fpfis/wikis/display/MULTISITE/AWS+Cloud9+-+Docker\">Docker</a>:</li>" +
    "<ul>" +
    "<li><a style='color:#729fcf' href=\"https://webgate.ec.europa.eu/fpfis/wikis/display/MULTISITE/AWS+Cloud9+-+Docker#AWSCloud9-Docker-DRAFT-Debugging-Xdebug\">Xdebug</a></li>" +
    "</ul>" +
    "</ul>" +
    "<h2>Lamp</h2>" +
    "<ul>" +
    "<li>Configure my environment for <a style='color:#729fcf' href=\"https://webgate.ec.europa.eu/fpfis/wikis/display/MULTISITE/AWS+Cloud9+-+Docker\">Apache/Mysql</a></li>" +
    "<li>Work with <a style='color:#729fcf' href=\"https://webgate.ec.europa.eu/fpfis/wikis/pages/viewpage.action?pageId=269522228\">Apache/Mysql</a>:</li>" +
    "<ul>" +
    "<li><a style='color:#729fcf' href=\"https://webgate.ec.europa.eu/fpfis/wikis/display/MULTISITE/AWS+Cloud9+-+Docker#AWSCloud9-Docker-DRAFT-Debugging-Xdebug\">Xdebug</a></li>" +
    "<li><a style='color:#729fcf' href=\"https://webgate.ec.europa.eu/fpfis/wikis/display/MULTISITE/AWS+Cloud9+-+Docker#AWSCloud9-Docker-DRAFT-Debugging-Xdebug\">ApacheSolr</a></li>" +
    "<li><a style='color:#729fcf' href=\"https://webgate.ec.europa.eu/fpfis/wikis/display/MULTISITE/AWS+Cloud9+-+Docker#AWSCloud9-Docker-DRAFT-Debugging-Xdebug\">MailDev</a></li>" +
    "</ul>";
  "</ul>";
});
